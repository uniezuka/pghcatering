...
<section class="woocommerce-order-details">
	...
	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
		...
		<tbody>
            ...
            ?>
                <tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'woocommerce-table__line-item order_item pgh_menu_day', $item, $order ) ); ?>">
                    <td colspan="2"><?php echo $day["text"] ?></td>
                </tr>
            <?php
